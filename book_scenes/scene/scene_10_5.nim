#[
    scene setup for 10.5 in the Ray Tracing in One Weekend
]#
...
proc render_10_5*() =
    ...
    world.add(newSphere(newPoint3(-1.0,    0.0, -1.0),   -0.4, materialLeft))
    world.add(newSphere(newPoint3( 1.0,    0.0, -1.0),   0.5, materialRight))

    var outputFile : File = open("./outputs/scene_10_5.ppm", FileMode.fmWrite)
