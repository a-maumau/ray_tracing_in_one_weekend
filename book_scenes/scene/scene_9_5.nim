#[
    scene setup for 9.5 in the Ray Tracing in One Weekend
]#
...
proc render_9_5*() =
    ...
    var
        ...
        materialLeft: Metal = newMetal(newColor(0.8, 0.8, 0.8))
        materialRight: Metal = newMetal(newColor(0.8, 0.6, 0.2))
    ...
    var outputFile : File = open("./outputs/scene_9_5.ppm", FileMode.fmWrite)
